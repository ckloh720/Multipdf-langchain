...
def main():
    ...
    <div style="
        ...
        text-align: center;
    ">
        <p>Adapted by CK from <a href='https://twitter.com/mehmet_ba7'>Mehmet Balioglu</a></p>
    </div>
    """
    ...
    if uploaded_files:
        ...
        qa = RetrievalQA.from_chain_type(llm=chat_openai, retriever=retriever, chain_type="map-rerank", verbose=True)
